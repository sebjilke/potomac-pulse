...
**Current version:** v35.5 | **Last calibration:** v30.0 (Feb 2026) | **Last structural change:** v35.0 (May 2026)

For the complete version history (v16 through v35.5), see [CHANGELOG.md](CHANGELOG.md).

---

*Generated by Potomac Pulse v35.5 — Client-side flow-state & graph robustness fix (read-time median selection of PoR history). No estimation logic changes for clean inputs.*
