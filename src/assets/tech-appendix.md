...
**Version:** 35.3 | **Date:** May 2026 | **Full changelog:** [CHANGELOG.md](CHANGELOG.md)
...
### 5.10 Uncertainty Display (Empirical 90% CI)
...
**Current version:** v36.0 | **Last calibration:** v30.0 (Feb 2026) | **Last structural change:** v36.0 (Jun 2026 — closed the learning loop: server end-applies the EMA correction; displayed model == validated model)

For the complete version history (v16 through v36.0), see [CHANGELOG.md](CHANGELOG.md).

---

*Generated by Potomac Pulse v36.0 — Closed the learning loop (C1): the server end-applies the learned EMA correction (unit gain, after the ensemble and ceiling) via a shared helper, so the stored / validated / learned / reported model is the corrected model the user sees. EMA learns on the raw residual (feedback-free); headline scores the corrected residual prequentially; cron is the sole prediction writer. MAJOR — re-baselined characterization. CI asymmetry/re-derivation (C2) deferred to v36.1.*
