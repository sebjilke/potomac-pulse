...
**Current version:** v35.6 | **Last calibration:** v30.0 (Feb 2026) | **Last structural change:** v35.0 (May 2026)

For the complete version history (v16 through v35.6), see [CHANGELOG.md](CHANGELOG.md).

---

*Generated by Potomac Pulse v35.6 — Reliability & data-integrity hardening from a re-verified science review (deploy test-gate, forecast-baseline storage, learning-pipeline deadlock + idempotency, write-path validation, honest sync-failure reporting, no fabricated gauge stage). No estimation logic changes.*
