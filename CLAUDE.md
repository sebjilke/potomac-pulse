...
- Keep `index.html` and `scheduled-update.js` in sync for any model logic change.
...
### Key files
`index.html` (client) and `scheduled-update.js` (server) — keep in sync for any model logic change.
...
## Current Model Parameters (v35.4)
